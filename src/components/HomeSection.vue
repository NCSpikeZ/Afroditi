...
.full-width-section
  .welcome-txt
    h1 Welcome to Afroditi
    p.wlcm Invest in the <span>crypto</span> of the most beautiful women in the world!
...
export default {
  ...
  methods: {
    createButtons() {
      const techButtons = [
        { logo: 'metamask.png', name: 'METAMASK' },
        { logo: 'trustwallet.png', name: 'TRUSTWALLET' },
        { logo: 'uniswap.png', name: 'UNISWAP V3' },
        { logo: 'ethereum.png', name: 'ETHEREUM LAYER 2' },
        { logo: 'metamask.png', name: 'METAMASK' },
        { logo: 'trustwallet.png', name: 'TRUST WALLET' },
      ];
