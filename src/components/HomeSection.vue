...
<script>
import { redirectToGame } from './Header.vue';
...
export default {
  ...
  methods: {
    ...
    createButtons() {
      const techButtons = [
        { logo: 'metamask.png', name: 'Action' },
        { logo: 'trustwallet.png', name: 'Aventure' },
        { logo: 'uniswap.png', name: 'Platformer' },
        { logo: 'ethereum.png', name: 'Side-Scroller' },
      ];
      ...
      techButtons.forEach(tech => {
        ...
        button.addEventListener('click', () => {
          this.$router.push('/projets/tfe/gameplay');
        });
